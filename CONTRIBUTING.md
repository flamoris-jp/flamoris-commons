# Contributing to FLAMORIS Commons

Thank you for your interest in FLAMORIS.

FLAMORIS Commons exists to provide shared foundations for the FLAMORIS ecosystem. Please keep changes focused, reusable, and small enough to understand.
...
# FLAMORIS Commons へのコントリビューション

FLAMORISに興味を持っていただきありがとうございます。

FLAMORIS Commonsは、FLAMORIS全体で再利用する共通基盤を置くための場所です。変更は、役割が明確で、再利用可能で、理解しやすい大きさを保ってください。
